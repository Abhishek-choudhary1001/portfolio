    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span className="highlight animate-text">Abhishek Choudhary</span>
        ...
        <div className="i-icons">
          <a
            href="https://github.com/Abhishek-choudhary1001/react-projects.git"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/abhishek-chaudhary-36a576348"
            target="_blank"
            rel="noopener noreferrer"
          >
